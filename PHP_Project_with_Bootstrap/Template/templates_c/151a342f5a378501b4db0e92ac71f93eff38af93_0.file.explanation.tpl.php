...
function content_642d00584ae8a3_53587717 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
        ...
        <?php $_smarty_tpl->_assignInScope('num_incorrect', (ord($_smarty_tpl->tpl_vars['user_ans']->value[$_smarty_tpl->tpl_vars['val']->value])-65));?>
        <?php $_smarty_tpl->_assignInScope('num_correct', (ord($_smarty_tpl->tpl_vars['correct']->value)-65));?>
...
$_smarty_tpl->_assignInScope('correct', $_prefixVariable3);?>
        <?php }?>
        <?php if ((isset($_smarty_tpl->tpl_vars['user_ans']->value[$_smarty_tpl->tpl_vars['val']->value]))) {?>
            ...
            <?php } else { ?>
                ...
                <?php if ($_smarty_tpl->tpl_vars['num_correct']->value == $_smarty_tpl->tpl_vars['key']->value) {?>
                    <label for="radio1" class="form-check-label answer_input text-success font-weight-bold" id='displayOption1'>
                        <?php echo $_smarty_tpl->tpl_vars['answer_data']->value['answer'];?>

                    </label></br>
                <?php } elseif ($_smarty_tpl->tpl_vars['key']->value == $_smarty_tpl->tpl_vars['num_incorrect']->value) {?>
